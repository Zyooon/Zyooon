...
> 이유 있는 설계를 지향하는 엔지니어 · Java/Spring 백엔드 → AI 개발자 전환 중

<br>

## 🧠 About Me

- **Java · Spring** 기반 백엔드 개발 경험을 바탕으로 **AI 엔지니어**로 전환 중입니다.
- LLM 기반 애플리케이션(RAG, Agent)과 컴퓨터 비전(YOLO, OpenCV) 분야를 집중 학습하고 있습니다.
- 구조와 흐름을 먼저 정의하고, 확장성과 유지보수를 고려한 설계를 지향합니다.
...
![RAG](https://img.shields.io/badge/RAG-4A90D9?style=flat-square&logoColor=white)
...
[![Email](https://img.shields.io/badge/Email-EA4335?style=flat-square&logo=gmail&logoColor=white)](mailto:wcw7373@gmail.com)
